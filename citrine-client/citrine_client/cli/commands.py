...
import citrine_client.cli.package as package
import citrine_client.cli.cli_io as cli_io
...
def command_status(args):
    client = api.CitrineClient(server, port)
...
def command_run(args):
    ...
    client = api.CitrineClient(server, port, async_=True)
