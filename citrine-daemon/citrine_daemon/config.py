...
if _platform == 'Linux':
    storage_path = os.path.join(os.getenv('HOME'), '.cache', 'citrine')
    config_path = os.path.join(os.getenv('HOME'), '.config', 'citrine')
elif _platform == 'Windows':
    storage_path = os.path.join(os.getenv('APPDATA'), 'citrine')
    config_path = os.path.join(os.getenv('APPDATA'), 'citrine')
...
default_config = {
    ...
    'worker_threads': 16,
    'repository_url': 'https://raw.githubusercontent.com/antonpaquin/citrine-repo/master/daemon/index',
}
