...
from citrine_ui import errors


_platform = platform.system()
if _platform == 'Linux':
    storage_path = os.path.join(os.getenv('HOME'), '.cache', 'citrine', 'ui')
    config_path = os.path.join(os.getenv('HOME'), '.config', 'citrine-ui')
elif _platform == 'Windows':
    storage_path = os.path.join(os.getenv('APPDATA'), 'citrine', 'ui')
    config_path = os.path.join(os.getenv('APPDATA'), 'citrine', 'ui')
...
def load_config() -> Dict[str, Any]:
    fname = os.path.join(config_path, 'citrine-ui.json')
