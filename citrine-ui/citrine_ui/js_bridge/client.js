class CitrineClient {
    constructor() {
        ...
        this._connection = new WebSocket("ws://localhost:" + _citrine_port + "/" + _citrine_key);
        this.daemon = {
            server: _citrine_daemon_server,
            port: _citrine_daemon_port,
        };
...
var citrineClient = new CitrineClient();
...
var citrineUtil = new CitrineUtil();
