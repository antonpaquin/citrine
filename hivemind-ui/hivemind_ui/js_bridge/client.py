...
class HivemindJSClient(QWebEngineScript):
    def __init__(self):
        super().__init__()
        ...
        prepend_src = (
            f'var _hivemind_port = "{socket_port}";\n'
            f'var _hivemind_key = "{self.key}";\n'
            f'var _hivemind_daemon_server = "{daemon_server}";\n'
            f'var _hivemind_daemon_port = {daemon_port};\n'
        )
